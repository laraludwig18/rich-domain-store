    ...
    public class ProductTests
    {
        ...
        public void Product_Validate_EmptyProductNameShouldThrowException()
        {
            var ex = Assert.Throws<DomainException>(() =>
                new Product(string.Empty, "Description", false, 100, Guid.NewGuid(), "Image", new Dimensions(1, 1, 1))
            );
        ...
        {
            var ex = Assert.Throws<DomainException>(() =>
                new Product("Name", string.Empty, false, 100, Guid.NewGuid(), "Image", new Dimensions(1, 1, 1))
            );
        ...
        {
            var ex = Assert.Throws<DomainException>(() =>
                new Product("Name", "Description", false, 0, Guid.NewGuid(), "Image", new Dimensions(1, 1, 1))
            );
        ...
        {
            var ex = Assert.Throws<DomainException>(() =>
                new Product("Name", "Description", false, 100, Guid.Empty, "Image", new Dimensions(1, 1, 1))
            );
        ...
        {
            var ex = Assert.Throws<DomainException>(() =>
                new Product("Name", "Description", false, 100, Guid.NewGuid(), string.Empty, new Dimensions(1, 1, 1))
            );
        ...
        {
            var ex = Assert.Throws<DomainException>(() =>
                new Product("Name", "Description", false, 100, Guid.NewGuid(), "Image", new Dimensions(0, 1, 1))
            );
